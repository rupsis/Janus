...
void Model::init() {
  mVertexData.vertices.resize(12);
  ...
  mVertexData.vertices[6].color = glm::vec3(0.0f, 0.5f, 0.5f);
  mVertexData.vertices[7].color = glm::vec3(0.0f, 0.5f, 0.5f);
  mVertexData.vertices[8].color = glm::vec3(0.0f, 0.5f, 0.5f);
  mVertexData.vertices[9].color = glm::vec3(0.0f, 0.5f, 0.5f);
  mVertexData.vertices[10].color = glm::vec3(0.0f, 0.5f, 0.5f);
  mVertexData.vertices[11].color = glm::vec3(0.0f, 0.5f, 0.5f);
  ...
  mVertexData.vertices[10].uv = glm::vec2(1.0, 0.0);
  mVertexData.vertices[11].uv = glm::vec2(1.0, 1.0);
